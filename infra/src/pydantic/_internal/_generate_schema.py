...
_VALIDATOR_F_MATCH: Mapping[
    ...
    ("before", "with-info"): lambda f,
    schema,
    field_name: core_schema.with_info_before_validator_function(f, schema, field_name=field_name),
    ("after", "with-info"): lambda f,
    schema,
    field_name: core_schema.with_info_after_validator_function(f, schema, field_name=field_name),
    ("plain", "with-info"): lambda f, _, field_name: core_schema.with_info_plain_validator_function(
        f, field_name=field_name
    ),
    ("wrap", "with-info"): lambda f,
    schema,
    field_name: core_schema.with_info_wrap_validator_function(f, schema, field_name=field_name),
}
