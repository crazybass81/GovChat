...
class IndexManagementClient(NamespacedClient):
    ...
    @query_params()
    def get_policy(self, policy: Any = None, params: Any = None, headers: Any = None) -> Any:
        """
    ...
    @query_params()
    def remove_policy_from_index(self, index: Any, params: Any = None, headers: Any = None) -> Any:
        """
    ...
    @query_params()
    def retry(self, index: Any, body: Any = None, params: Any = None, headers: Any = None) -> Any:
        """
    ...
    @query_params()
    def delete_policy(self, policy: Any, params: Any = None, headers: Any = None) -> Any:
        """
