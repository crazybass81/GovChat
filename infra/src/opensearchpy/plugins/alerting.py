...
class AlertingClient(NamespacedClient):
    ...
    @query_params()
    def get_monitor(self, monitor_id: Any, params: Any = None, headers: Any = None) -> Any:
        """
    ...
    @query_params("dryrun")
    def run_monitor(self, monitor_id: Any, params: Any = None, headers: Any = None) -> Any:
        """
    ...
    @query_params()
    def create_monitor(self, body: Any = None, params: Any = None, headers: Any = None) -> Any:
        """
    ...
    @query_params()
    def delete_monitor(self, monitor_id: Any, params: Any = None, headers: Any = None) -> Any:
        """
    ...
    @query_params()
    def create_destination(self, body: Any = None, params: Any = None, headers: Any = None) -> Any:
        """
