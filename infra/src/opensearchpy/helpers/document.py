...
class Document(ObjectBase):
    ...
    def search(cls, using: Any = None, index: Any = None) -> Any:
        ...
        over this ``Document``.
        """
        return Search(using=cls._get_using(using), index=cls._default_index(index), doc_type=[cls])
    ...
    @classmethod
    def exists(cls, id: Any, using: Any = None, index: Any = None, **kwargs: Any) -> Any:
        """
    ...
    def mget(
        ...
        **kwargs: Any,
        ...
        body = {
            "docs": [
                doc if isinstance(doc, collections_abc.Mapping) else {"_id": doc} for doc in docs
            ]
        }
