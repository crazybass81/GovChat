...
class Request:
    ...
    def _clone(self) -> Any:
        s = self.__class__(using=self._using, index=self._index, doc_type=self._doc_type)
...
class Search(Request):
    ...
    def execute(self, ignore_cache: bool = False) -> Any:
        ...
        if ignore_cache or not hasattr(self, "_response"):
            ...
            self._response = self._response_class(
                self,
                opensearch.search(index=self._index, body=self.to_dict(), **self._params),
            )
    ...
    def scan(self) -> Any:
        ...
        for hit in scan(opensearch, query=self.to_dict(), index=self._index, **self._params):
    ...
    def delete(self) -> Any:
        ...
        return AttrDict(
            opensearch.delete_by_query(index=self._index, body=self.to_dict(), **self._params)
        )
...
class MultiSearch(Request):
    ...
    def execute(self, ignore_cache: Any = False, raise_on_error: Any = True) -> Any:
        ...
        if ignore_cache or not hasattr(self, "_response"):
            ...
            responses = opensearch.msearch(index=self._index, body=self.to_dict(), **self._params)
