...
def create_point_in_time(self: Any, index: Any, params: Any = None, headers: Any = None) -> Any:
    """
...
@query_params()
def update_audit_config(self: Any, body: Any, params: Any = None, headers: Any = None) -> Any:
    """
