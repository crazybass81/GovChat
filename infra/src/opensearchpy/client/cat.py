...
class CatClient(NamespacedClient):
    ...
    def health(
        ...
        :arg v: Verbose mode. Display column headers. Default is false.
        """
        return self.transport.perform_request("GET", "/_cat/health", params=params, headers=headers)

    @query_params("error_trace", "filter_path", "help", "human", "pretty", "s", "source")
    def help(
        self,
        params: Any = None,
        headers: Any = None,
        ...
        :arg source: The URL-encoded request definition. Useful for
            libraries that do not accept a request body for non-POST requests.
        """
        return self.transport.perform_request("GET", "/_cat", params=params, headers=headers)
    ...
    def master(
        ...
        return self.transport.perform_request("GET", "/_cat/master", params=params, headers=headers)
    ...
    def nodes(
        ...
        :arg v: Verbose mode. Display column headers. Default is false.
        """
        return self.transport.perform_request("GET", "/_cat/nodes", params=params, headers=headers)
    ...
    def tasks(
        ...
        :arg v: Verbose mode. Display column headers. Default is false.
        """
        return self.transport.perform_request("GET", "/_cat/tasks", params=params, headers=headers)
