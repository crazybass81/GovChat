...
class OpenSearch(Client):
    ...
    def __init__(
        self, hosts: Any = None, transport_class: Type[Transport] = Transport, **kwargs: Any
    ) -> None:
        """
    ...
    def ping(
        ...
        """
        try:
            return self.transport.perform_request("HEAD", "/", params=params, headers=headers)
    ...
    def info(
        ...
        :arg source: The URL-encoded request definition. Useful for
            libraries that do not accept a request body for non-POST requests.
        """
        return self.transport.perform_request("GET", "/", params=params, headers=headers)
    ...
    @query_params("error_trace", "filter_path", "human", "pretty", "requests_per_second", "source")
    ...
    def exists_source(
        ...
        return self.transport.perform_request("HEAD", path, params=params, headers=headers)
    ...
    def get_source(
        ...
        return self.transport.perform_request("GET", path, params=params, headers=headers)
