...
class AsyncOpenSearch(Client):
    ...
    async def ping(
        ...
        """
        try:
            return await self.transport.perform_request("HEAD", "/", params=params, headers=headers)
    ...
    async def info(
        ...
        :arg source: The URL-encoded request definition. Useful for
            libraries that do not accept a request body for non-POST requests.
        """
        return await self.transport.perform_request("GET", "/", params=params, headers=headers)
    ...
    async def exists_source(
        ...
        return await self.transport.perform_request("HEAD", path, params=params, headers=headers)
    ...
    async def get_source(
        ...
        return await self.transport.perform_request("GET", path, params=params, headers=headers)
