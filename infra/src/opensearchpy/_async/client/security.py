...
class SecurityClient(NamespacedClient):
    ...
    async def get_action_group(
        ...
        if action_group in SKIP_IN_PATH:
            raise ValueError("Empty value passed for a required argument 'action_group'.")
    ...
    async def delete_distinguished_name(
        ...
        if cluster_name in SKIP_IN_PATH:
            raise ValueError("Empty value passed for a required argument 'cluster_name'.")
    ...
    async def generate_user_token(
        ...
        return await self.transport.perform_request(
            "POST",
            _make_path("_plugins", "_security", "api", "internalusers", username, "authtoken"),
            params=params,
            headers=headers,
        )
    ...
    @query_params("accept_invalid", "error_trace", "filter_path", "human", "pretty", "source")
    async def validate(
        self,
        params: Any = None,
        headers: Any = None,
