...
@query_params()
async def list_all_point_in_time(self: Any, params: Any = None, headers: Any = None) -> Any:
    """
...
@query_params("expand_wildcards", "ignore_unavailable", "keep_alive", "preference", "routing")
...
@query_params()
async def update_audit_config(self: Any, body: Any, params: Any = None, headers: Any = None) -> Any:
    """
    ...
    return await self.update_audit_configuration(params=params, headers=headers, body=body)
