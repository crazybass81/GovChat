...
class IndexManagementClient(NamespacedClient):
    ...
    @query_params()
    async def get_policy(self, policy: Any = None, params: Any = None, headers: Any = None) -> Any:
        """
    ...
    async def explain_index(self, index: Any, params: Any = None, headers: Any = None) -> Any:
        """
    ...
    @query_params()
    async def delete_policy(self, policy: Any, params: Any = None, headers: Any = None) -> Any:
        """
