...
class AsyncSearch(Request):
    ...
    async def execute(self, ignore_cache: bool = False) -> Any:
        ...
        if ignore_cache or not hasattr(self, "_response"):
            ...
            self._response = self._response_class(
                self,
                await opensearch.search(index=self._index, body=self.to_dict(), **self._params),
            )
    ...
    async def scan(self) -> Any:
        ...
        async for hit in aiter(
            async_scan(opensearch, query=self.to_dict(), index=self._index, **self._params)
        ):
    ...
    async def delete(self) -> Any:
        ...
        return AttrDict(
            await opensearch.delete_by_query(index=self._index, body=self.to_dict(), **self._params)
        )
...
class AsyncMultiSearch(Request):
    ...
    async def execute(self, ignore_cache: bool = False, raise_on_error: bool = True) -> Any:
        """
