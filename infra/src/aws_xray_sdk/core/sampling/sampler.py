...
class DefaultSampler:
    ...
    def __init__(self):
        ...
        self._target_poller = TargetPoller(self._cache, self._rule_poller, self._connector)
    ...
    def load_settings(self, daemon_config, context, origin=None):
        ...
        self._connector.setup_xray_client(
            ip=daemon_config.tcp_ip, port=daemon_config.tcp_port, client=self.xray_client
        )
