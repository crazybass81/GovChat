...
def patch():
    ...
    wrapt.wrap_function_wrapper("psycopg2.extensions", "register_type", _xray_register_type_fix)
    wrapt.wrap_function_wrapper("psycopg2.extensions", "quote_ident", _xray_register_type_fix)
