...
from aws_xray_sdk.ext.boto_utils import aws_meta_processor, inject_header
...
def patch():
    ...
    if hasattr(botocore.client, "_xray_enabled"):
        return
    botocore.client._xray_enabled = True
...
def _xray_traced_botocore(wrapped, instance, args, kwargs):
    ...
    if service == "xray":
        ...
        if "GetSamplingRules" in args or "GetSamplingTargets" in args or "PutTraceSegments" in args:
