...
from aws_xray_sdk.ext.util import get_hostname, inject_trace_header, strip_url
...
def requests_processor(wrapped, instance, args, kwargs, return_value, exception, subsegment, stack):
