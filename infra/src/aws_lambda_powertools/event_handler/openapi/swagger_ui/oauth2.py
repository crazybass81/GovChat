...
class OAuth2Config(BaseModel):
    ...
    additionalQueryStringParams: Dict[str, str] = Field(
        alias="additional_query_string_params", default={}
    )
    ...
    usePkceWithAuthorizationCodeGrant: bool = Field(
        alias="use_pkce_with_authorization_code_grant", default=False
    )
