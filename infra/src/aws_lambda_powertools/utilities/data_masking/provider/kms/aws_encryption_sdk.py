...
class AWSEncryptionSDKProvider(BaseProvider):
    ...
    def encrypt(
        self, data: Any, provider_options: dict | None = None, **encryption_context: str
    ) -> str:
        return self._key_provider.encrypt(
            data=data, provider_options=provider_options, **encryption_context
        )

    def decrypt(
        self, data: str, provider_options: dict | None = None, **encryption_context: str
    ) -> Any:
        return self._key_provider.decrypt(
            data=data, provider_options=provider_options, **encryption_context
        )
...
class KMSKeyProvider:
    ...
    def __init__(
        ...
        self.key_provider = StrictAwsKmsMasterKeyProvider(
            key_ids=self.keys, botocore_session=session
        )
