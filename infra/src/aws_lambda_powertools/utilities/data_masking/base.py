...
class DataMasking:
    ...
    def erase(
        self, data: Sequence | Mapping, fields: list[str] | None = None
        ...
        for field_parse in fields:
            ...
            if not result_parse:
                if self.raise_on_missing_field:
                    ...
                    raise DataMaskingFieldNotFoundError(
                        f"Field or expression {field_parse} not found in {data_parsed}"
                    )
                else:
            ...
            json_parse.update(
                data_parsed,
                lambda field_value, fields, field_name: update_callback(
                    field_value, fields, field_name
                ),  # type: ignore[misc] # noqa: B023
            )
    ...
    def _call_action(
        ...
        **encryption_context,
        ...
        fields[field_name] = action(
            field_value, provider_options=provider_options, **encryption_context
        )
