...
class FeatureFlags:
    ...
    def _evaluate_conditions(
        ...
        for condition in conditions:
            ...
            if not self._match_by_action(
                action=cond_action, condition_value=cond_value, context_value=context_value
            ):
                self.logger.debug(
        ...
        *,
        ...
        for rule_name, rule in rules.items():
            ...
            if self._evaluate_conditions(
                rule_name=rule_name, feature_name=feature_name, rule=rule, context=context
            ):
    ...
    def evaluate(
        self, *, name: str, context: dict[str, Any] | None = None, default: JSONType
    ) -> JSONType:
