...
class RawMasterKey(MasterKey):
    ...
    def __new__(cls, **kwargs):
        ...
        instance._key_info_prefix = (
            aws_encryption_sdk.internal.formatting.serialize.serialize_raw_master_key_prefix(  # noqa pylint: disable=protected-access
    ...
    def owns_data_key(self, data_key):
        ...
        if (
            ...
            self.config.wrapping_key.wrapping_algorithm.encryption_type is EncryptionType.SYMMETRIC
        ):
