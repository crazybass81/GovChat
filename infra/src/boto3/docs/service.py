...
class ServiceDocumenter(BaseServiceDocumenter):
    ...
    def client_api(self, section):
        ...
        Boto3ClientDocumenter(self._client, self._root_docs_path, examples).document_client(section)
    ...
    def _document_service_resource(self, section):
        ...
        breadcrumb_section.style.ref(self._client.__class__.__name__, f"../../{self._service_name}")
    ...
    def _document_resources(self, section):
        ...
        for resource_name in json_resource_model["resources"]:
            ...
            ResourceDocumenter(resource, self._session, self._root_docs_path).document_resource(
